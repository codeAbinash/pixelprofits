  ...
  function createAccount() {
    ...
    if (!name || name.length < 3)
      return setModalAlert([
        {
          title: 'Warning',
          description: 'lease enter your name (min 3 characters)',
        },
      ])
    if (!email) return setModalAlert([{ title: 'Warning', description: 'Please enter your email' }])
    if (!mobileNumber) return setModalAlert([{ title: 'Warning', description: 'Please enter your mobile number' }])
    ...
    <SafeAreaView style={styles.main}>
      ...
      <ScrollView>
        ...
        <View style={[styles.topContainer, { paddingBottom: 10 }]}>
          ...
          <Text style={styles.title}>Sign Up to Pixelprofits</Text>
          <Text style={styles.description}>Sign Up to Pixelprofits to watch and win</Text>
        </View>
        ...
        <View style={[styles.inputContainer]}>
          ...
          <Text style={styles.label}>
            Refer Code <Text style={{ color: '#aaa' }}>(optional)</Text>
          </Text>
          <View style={styles.singleInputContainer}>
