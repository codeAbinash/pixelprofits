    ...
    <SafeAreaView style={styles.main}>
      ...
      <ScrollView>
        ...
        <View style={styles.topContainer}>
          ...
          <Text style={styles.title}>Log In to Pixelprofits</Text>
          <Text style={styles.description}>Log In to Pixelprofits to watch and win</Text>
        </View>
      ...
      setModals([
        {
          ...
          description: 'Please enter a phone number which you have used to sign up.',
        },
      ])
      return
    }
