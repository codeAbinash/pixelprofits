      ...
      <ScrollView style={{ padding: 20 }}>
        ...
        >
          ...
          {!signUp && (
            ...
            >
              <Text style={{ color: colors.accent, fontFamily: fonts.medium }}> Edit Number?</Text>
            </TouchableOpacity>
          )}
        </View>
        ...
        <View style={styles.buttonsContainer}>
          <TouchableOpacity
            style={[buttons.full, { opacity: isValidOtp ? 1 : 0.5 }]}
            onPress={handelOtpSubmit}
            activeOpacity={0.8}
          ...
          >
            ...
            <TouchableOpacity onPress={() => {}}>
              <Text style={{ color: colors.accent, fontFamily: fonts.medium }}> Resend OTP</Text>
            </TouchableOpacity>
          </View>
        </View>
