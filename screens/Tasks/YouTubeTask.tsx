      ...
      setModals([
        {
          title: 'Are you sure?',
          description:
            'Are you sure you want to go back? This will stop your recording to complete the task and you have to start again.',
          type: 'success',
          active: true,
          buttons: [
            { text: 'No' },
              ...
              >
                {isExpired ? null : isUploading ? (
                  uploadingIndex === index ? (
                    ...
                    <TouchableOpacity
                      style={[buttons.full, { width: width - 40, backgroundColor: 'grey' }]}
                      activeOpacity={0.8}
                      disabled
                    >
                      <Image
                  ...
                  <>
                    <TouchableOpacity
                      style={[buttons.full, { width: (width * 2) / 3 - 25, backgroundColor: 'red' }]}
                      activeOpacity={0.8}
                    ...
                    {recordingIndex === -1 ? (
                      <>
                        <TouchableOpacity
                          ...
                          activeOpacity={0.8}
                          onPress={() => startRecording(index, id)}
                        >
                          <Image
                            source={icons.record}
                            style={{
  ...
  data: [
    {
      ...
      referred_by: null,
      updated_at: '2023-04-09T11:39:35.000000Z',
    },
  ],
