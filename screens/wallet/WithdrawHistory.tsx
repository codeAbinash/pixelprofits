        ...
        return (
          ...
          >
            <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
              <View>
                <Image source={icons.coins} style={{ height: 40, aspectRatio: 1, resizeMode: 'contain' }} />
              </View>
              <View>
                ...
                >
                  ...
                  >
                    to {accountDataParsed.account_number}
                  </Text>
                  <Text
                    style={{
                      fontSize: 12,
...
function getStatusColor(color: string) {
  if (color === 'processing') return 'orange'
  else if (color === 'success') return 'limegreen'
  else if (color === 'failed') return 'red'
}
