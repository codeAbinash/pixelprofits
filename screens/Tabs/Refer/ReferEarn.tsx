      ...
      <View style={styles.top}>
        ...
        <View style={[styles.flexRow, { gap: 20 }]}>
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => {
              navigation.navigate('ReferHistory')
            }}
          >
            <View>
      ...
      <View style={{ padding: 20, paddingTop: 5, gap: 20 }}>
        <View style={[referStyles.lightCard, { gap: 10 }]}>
          ...
          <ButtonFull
            ...
            onPress={() => {
              shareText(
                `Check out Pixelprofits App on the Google Play Store using this link: ${playStoreLink}. Use my referral code ${referCode} for a special bonus when you sign up. Enjoy!`,
              )
            }}
          />
        </View>
        ...
        <View style={[referStyles.lightCard, referStyles.referCard, { paddingLeft: 0 }]}>
          ...
          <View style={{ width: '54%', flexDirection: 'row', gap: 15 }}>
            ...
            >
              If they complete 10 YouTube task continuously.
            </Text>
          </View>
        </View>
