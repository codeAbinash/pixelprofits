      ...
      <ScrollView>
        ...
        >
          <View style={[styles.flexRow, { gap: 15 }]}>
            <View>
              <Image
                source={profile_pic ? { uri: profile_pic } : icons.user_icon}
                style={{
                  height: 70,
                  width: 70,
                  borderRadius: 70,
          ...
          >
            ...
            <View className='rounded-full p-3' style={{ backgroundColor: colors.accentLight }}>
              <Image
                source={icons.pencil}
                style={{
                  height: 15,
